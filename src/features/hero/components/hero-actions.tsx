  ...
  return (
    <div className="grid w-full grid-cols-3 gap-2 sm:flex sm:w-auto sm:gap-4">
      <Button
        ...
        className="flex size-auto cursor-pointer items-center justify-between gap-2 rounded-full bg-lime-400 py-1.5 pr-1.5 pl-3 text-[11px] font-bold text-black shadow-[0_4px_20px_rgba(163,230,53,0.3)] transition-all duration-200 hover:bg-lime-500 hover:shadow-[0_6px_25px_rgba(163,230,53,0.4)] active:translate-y-px active:scale-[0.98] sm:py-2 sm:pr-2 sm:pl-5 sm:text-sm"
      >
        <span>Thêm giỏ</span>
      ...
      <Button
        ...
        className="flex size-auto cursor-pointer items-center justify-between gap-2 rounded-full border border-slate-200 bg-white py-1.5 pr-1.5 pl-3 text-[11px] font-bold text-slate-800 shadow-sm transition-all duration-200 hover:bg-slate-50 active:translate-y-px active:scale-[0.98] sm:py-2 sm:pr-2 sm:pl-5 sm:text-sm dark:border-slate-800 dark:bg-[#131B2E]/60 dark:text-white dark:hover:bg-[#1E293B]"
      >
