      ...
      <FieldGroup className="gap-6">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <Field data-invalid={!!errors.name}>
            <FieldLabel
              htmlFor="name"
              className="text-xs font-bold tracking-wider text-slate-900 uppercase opacity-80 dark:text-white"
            >
              Họ tên
            </FieldLabel>
            <Input
              ...
              className={`dark:bg-background h-auto rounded-xl border bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-400 transition-all duration-200 outline-none focus-visible:ring-0 focus-visible:ring-offset-0 dark:text-white dark:placeholder-slate-500 ${
                errors.name
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <Field data-invalid={!!errors.cats}>
            <FieldLabel
              htmlFor="cats"
              className="text-xs font-bold tracking-wider text-slate-900 uppercase opacity-80 dark:text-white"
            >
            ...
            />
            {errors.cats && <FieldError>{errors.cats}</FieldError>}
          </Field>
        </div>

        <Field>
          <FieldLabel className="text-xs font-bold tracking-wider text-slate-900 uppercase opacity-80 dark:text-white">
            Gói đi kèm
          </FieldLabel>
              ...
              (chip) => {
                ...
                return (
                  <Button
                    ...
                    className={`text-xs font-bold hover:bg-lime-500 ${
                      active ? "bg-lime-400 text-black shadow-md" : ""
                    }`}
                  >
                    {chip} {active && "✓"}
                  </Button>
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <Button
            ...
            className="group flex h-auto flex-1 cursor-pointer items-center justify-between rounded-xl bg-lime-400 py-2 pr-2 pl-6 text-sm font-bold text-black shadow-[0_4px_20px_rgba(163,230,53,0.3)] transition-all duration-200 select-none hover:bg-lime-500 hover:shadow-[0_4px_25px_rgba(163,230,53,0.4)] active:translate-y-px active:scale-[0.97] disabled:opacity-50"
          >
